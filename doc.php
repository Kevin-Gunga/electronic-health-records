    ...
    <div class="container front">
        ...
        <div class="form">
            <form action="" method="POST">
                ...
                <button type="submit" class="btn"> <a href="form.php">Log in</a></button>
    ...
    <div class="container back">
        ...
        <div class="form formBack">
            <form>
                ...
                <button type="submit" name="sign_btn" class="btn btnBack"> <a href="form.php">Sign Up</a></button>
